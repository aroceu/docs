...
<p>Each design represents a level of familiarity, fun, or personal attachment I feel to the page content, while being appropriate for the webpage's intent. I used to redesign my websites all the time when I was younger; but over time as I've learned and developed better skills, my code has become more complex and I'm not as fond of the idea anymore. I prefer seeing how long I can be happy with a design these days.</p>

<p>If you'd like to learn more about each website, click on their link in the list below to take you to further documentation.</p>
...
<h4>stuff</h4>
<p>I decided to remove <b>stuff</b>, which used to host sozai (graphics/web content), in October of 2024 due to redundancy as well as my general preference for sharing my graphics (which I make more of these days than website codes) on my <a href="https://ceu.dreamwidth.org">Dreamwidth</a> instead. When it was up, I used <a href="https://picocms.org">Pico</a> as its content management system.</p>
<h4>love</h4>
