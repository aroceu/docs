...
<ul><li><a href="#design">Design Philosophies</a></li>
	...
	<li><a href="#origins">Origins</a></li></ul>
...
<p>I start here when talking about how I build websites, because it's how I started. But my primary approach now centers text content and convenience, neither of which images are really a necessity for. I learned this from my own experiences with myself; a lot of my early designs were very graphic design-dependent, and though I'm sure my skill now would be a vast improvement from then, I also know that mentally, it feels rigid in existence for me. What if I want to change something, or need to add something, or decide I want to move certain things around, or realize that the way something in an image would look better in a different position/font/color ages after I published it? Sure, I can always edit it &mdash; but the point is that I'm an incredibly indecisive person who also wants things to last for a long time, and the way I feel about custom graphics on my own website is often not compatible with that, even if the time to edit an image took the same amount of time to edit code.</p>
...
<p>I also now enjoy using graphics made by others a lot more than I used to. When I was younger, I was much more possessive and selective about having graphics that I would make, as part of a personal neurosis for being entirely self-made. But since then I've relaxed, especially when it comes to building webpages that <i>aren't</i> just about the things that I've made. Creativity is not an antonym of transformative, and it brings me a lot of joy to be inspired by others and use the resources available to me to build something that's not only representative of me, but also how I see and interact with the world.</p>
...
<p>Then I get to coding, starting with a local file and building from there. I do have XAMPP installed but I'm usually too lazy to run it to test PHP, so I write in HTML/CSS first, and convert to PHP/Javascript upon uploading. My only exception to this is WordPress themes &mdash; I always use XAMPP when I make those. Writing CSS is the most fun part for me and the HTML is the easiest though, so I don't mind it either way. I like to put everything into one file at this stage and split it up (stylesheets, PHP, headers/footers) later.</p>

<p>For the most part, I code modularly and use semantic tags. And since I'm a little better than I used to be, I leave comments to indicate certain parts of a webpage or stylesheet so if I want to tweak it later, I know what I'm tweaking where without needing to double check the code. I start by writing the HTML so I have stuff to stylize and move around when I get to the stylesheet. Since I know this is a "rough draft" stage of my website, I'm not super concerned with its optimal wording just yet.</p>

<p>After that, I write the CSS. If I decide I want to add more HTML elements while writing the stylesheet, I work on both interchangeably. If there are any images I want to use on the webpage, I look for them or create them during this stage as well, so I can add them to the code. Since I've already drawn the design, writing the CSS is just making sure the webpage looks the way I envisioned it and adding things that would make it more lively, if needed.</p>

<p>By hosting locally, I can refresh with every update and work in as bad practice I want. While coding, I tend to have one of my existing websites' code open to refer to, because for more elaborate sites/pages I don't like writing from pure scratch &mdash; there's usually something I'm forgetting. If external resources such as scripts or decorative graphics are involved, I download them directly to link from them locally in the code as well. My files are not very well organized though; I just operate however is convenient to me, as I do.</p>

<p>For larger projects (2+ files), I push the files for the website through Cyberduck, my FTP application of choice. For smaller projects, I may either use Cyberduck or cPanel, depending on how I'm feeling. I convert pages to PHP in this stage, right before uploading, though for larger sites this may take some time. As I've recently moved a lot of my webpages to Github repositories, my workflow for those projects now includes pushing updates through Github (and then cPanel).</p>

<p>Once the website is online, I do a bunch of testing, <i>trying</i> not to impatiently refresh for every little thing. I basically click on every link and interact with every element of every webpage to make sure everything is working the way it did locally or the way I intend it to. A lot of times while troubleshooting I get better or newer ideas, so it's not unusual for me to make a slightly more significant change even at this point in development. I'm also a perfectionist with wording, so I do a lot of copyediting and alt text writing/rewriting in this stage.</p>

<p>I save the responsive design for last because I don't find it particularly interesting or fun; it's my least favorite part of web development. But I understand its necessity, especially in terms of accessibility, so I configure it at the end.</p>

<p>Pages that get regularly updated, such as sections in my library, my Pok&eacute;mon site, my indie portal, prompt generators, and links, all utilize PHP or iframes. Though I don't have official "templates", my own semantic code makes it easy for me to make additions. Topical updates are separated into folders and smaller pages from the backend to save myself some scrolling. My /fic and /projects run and get updated via WordPress.</p>

<p>I do believe that much like fashion, a website's development is never over. I'm always interested in ways to improve my websites, or make more of them. So, eventually, the workflow stays in this troubleshooting stasis period forever, or starts all over again. </p>


<h1 id="origins">Origins</h1>

<p>I learned the foundations of what it means to code on <a href="https://en.wikipedia.org/wiki/Myspace">MySpace</a>, and eventually learned more little by little through <a href="https://en.wikipedia.org/wiki/IMVU">IMVU</a> and <a href="https://en.wikipedia.org/wiki/Quizilla">Quizilla</a>. MySpace and IMVU had similar types of code tweaking in adding nested and floating elements, changing colors of things, making little flourishes but essentially moving elements around on a pre-existing page. Quizilla showed me the fluidity of webdesign &mdash; and what it meant to truly customize a webpage for yourself.</p>

<p>I learn best by doing, so that's what I did. I took other people's code and tried to adjust it to my own liking, but didn't know what I was doing. Like playing a video game for the first time but not reading any of the text. Eventually, though, after much trial and error (and maybe glancing over one or two tutorials when I was getting desperate) I understood the basics of code. Through Quizilla I had also found <a href="https://en.wikipedia.org/wiki/Freewebs">Freewebs</a>, which eventually got named to Webs and the Neocities of its day. Because I had found these sites through the footers of those who were using custom layouts, this was the first type of personal website I got introduced to: those that made layouts for others.</p>
...
<p>The subdomain felt like a true attempt at sophistication It was also the first time I tried (and succeeded) at writing the code from scratch on my own. I had branched beyond the sozai artists, and stumbled across bloggers &mdash; they offered content as well, but also wrote extensively about their lives. It seemed interesting to me, someone who loves to write and spin narratives out of everything. In this time I also learned PHP, and started learning what code <i>meant</i> not just what it does. Eventually, for my somethingteenth birthday I asked my mom for a domain as a gift, and she gave it to me. The domain was on a whim and wasn't something I felt personally connected to, but it was a fulfilling purchase nonetheless, and motivated me to continue to do this, and to be better, for <i>me</i>.</p>
...
<p>A semi-successful couple of years of blogging later, I purchased a domain again, but still with the purpose of blogging. That period of my life was particularly difficult and my blog posts reflected that; but despite that, the WordPress themes I made under that domain, both for my website and otherwise, were excellent and I like to show them off even today.</p>

<p>But because the memories and association with my old blog were so negative, I eventually ditched it and created a new username: aroceu. I bought this domain at the time, but I also bought another one that I wanted to act as my primary domain. I dabbled in fanlistings and collectives for a short while, before I realized that much like anything else I'm interested in, I can't commit to something if I'm not hyperfixated on it.</p>
