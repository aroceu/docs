...
<p>Then I get to coding, starting with a local file and building from there. I do have XAMPP installed but I'm usually too lazy to run it to test PHP, so I write in HTML/CSS first, and convert to PHP upon uploading. My only exception to this is WordPress themes &mdash; I always use XAMPP when I make those. Writing CSS is the most fun part for me and the HTML is the easiest though, so I don't mind it either way. I like to put everything into one file at this stage and split it up (stylesheets, PHP, headers/footers) later.</p>
